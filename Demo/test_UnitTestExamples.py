...
class MyTestCase(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.assertEqual(Example.add(self,10,20), 30) # Second variant of writing
        self.assertEqual(Example.add(self,0,0), 0) # Second variant of writing
        self.assertEqual(Example.add(self,-1,1), 0) # Second variant of writing
